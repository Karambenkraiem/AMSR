...
/* ── icône Safari Share (SVG officiel simplifié) ──────────────── */
const IconShare = () => (
  <svg viewBox="0 0 24 24" className="w-5 h-5 inline-block" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
/* ── section iOS : guide pas-à-pas ───────────────────────────── */
function IosGuide() {
  return (
    <div className="space-y-3">
      <p className="text-sm font-semibold text-gray-800">
        Installer sur iPhone / iPad — gratuit, sans App Store
      </p>
      <div className="bg-blue-50 border border-blue-100 rounded-xl p-3 space-y-2.5">
        <Step n="1" text={<>Ouvre ce site dans <span className="font-bold">Safari</span> (pas Chrome)</>} />
        <Step n="2" text={<>Appuie sur l'icône Partager <IconShare /> en bas</>} />
        <Step n="3" text={<>Sélectionne <span className="font-bold">« Ajouter à l'écran d'accueil »</span></>} />
        <Step n="4" text={<>Appuie sur <span className="font-bold">Ajouter</span> — l'app apparaît sur ton écran</>} />
      </div>
      <p className="text-xs text-gray-400 text-center leading-relaxed">
        L'app s'ouvre en plein écran, sans barre Safari, comme une vraie application.
      </p>
    </div>
  );
}
...
function Step({ n, text }) {
  return (
    <div className="flex items-start gap-2.5">
      <div className="w-5 h-5 rounded-full bg-blue-600 text-white text-xs font-bold flex items-center justify-center shrink-0 mt-0.5">
        {n}
      </div>
      ...
      >
        ...
        <div className="p-5 space-y-4">
          ...
          <div className="flex items-start gap-3">
            ...
            <button
              onClick={dismiss}
              className="text-gray-300 hover:text-gray-500 text-xl w-8 h-8 flex items-center justify-center rounded-full hover:bg-gray-100"
            >
              ×
            </button>
          </div>
          ...
          {isAndroid && (
            <div className="space-y-3">
              <p className="text-sm text-gray-600 leading-relaxed">
                Téléchargez et installez l'application STEG directement sur votre Android.
              </p>
              <a
                href={APK_URL}
                onClick={dismiss}
              ...
              <p className="text-[11px] text-gray-400 text-center leading-relaxed">
                Si demandé, activez « Sources inconnues » dans Paramètres › Sécurité
              </p>
            </div>
          )}
          ...
          {!isMobile && (
            <div className="space-y-3">
              <p className="text-sm text-gray-600">
                Accédez à AMSR depuis votre smartphone :
              </p>
              <div className="grid grid-cols-2 gap-2">
                <a href={APK_URL} className="flex items-center gap-2 bg-gray-900 hover:bg-gray-700 text-white px-3 py-2.5 rounded-xl transition-colors">
                  ...
                  <div>
                    <div className="text-[9px] text-gray-400 leading-none">Fichier APK</div>
                    <div className="text-xs font-bold leading-tight">Android</div>
                  </div>
                </a>
                <div className="flex items-center gap-2 bg-gray-100 text-gray-400 px-3 py-2.5 rounded-xl">
                  <IconApple cls="w-5 h-5 shrink-0" />
                  <div>
                    <div className="text-[9px] text-gray-400 leading-none">Safari → Partager</div>
                    <div className="text-xs font-bold leading-tight">iPhone / iPad</div>
                  </div>
                </div>
              </div>
            </div>
